  ...
  */
  generateNode(commitData) {
	...
	for(var i = 1; i<this.height - 3; i++){
		...
		*/
		this.tileSet[this.height - 1][i] = new Wall(100*(this.width-3), (100*i), -1, 1, 100, 100, tileFrames.wall1);
	}
	for(var i = 1; i<this.width - 3; i++){
		this.tileSet[i][0] = new Wall( (100*i), 0, 1, 1, 100, 100, tileFrames.wall2);
		this.tileSet[this.width-1][i] = new Wall((100*i), 100*(this.height-3), 1, 1, 100, 100, tileFrames.wall2);
	}
